...
string name = "Muhammad Naufal Abdillah";
string id = "2410817310007";
string inputSendiri;
...
void shellSort(string &str, int n){
 ...
 int main(){
    ...
    do {
        ...
        cout << "| 7. Exit              |" << endl;
        cout << "<======================>" << endl;
        cout << "Masukan Pilihan : "; cin >> ch;
        cin.ignore();
        system("cls");
        
        if(ch >= 1 && ch <= 6){
            cout << "Pilih data yang Ingin diurutkan" << endl;
            cout << "1. Name" << endl;
            cout << "2. Id" << endl;
            cout << "3. Input Sendiri" << endl;
            cout << "Masukan Pilihan : "; cin >> DataChoice;
            cin.ignore();
        ...
        switch(DataChoice){
            ...
            case 3 :
            cout << "Masukan Data yang ingin diurutkan : ";
            getline (cin, inputSendiri);
            temp = inputSendiri;
            break;

            default:
            cout << "Pilihan Data tidak valid!" << endl;
        ...
        switch(ch){
            ...
            cout << "This Program was made By Muhammad Naufal Abdillah (2410817310007)" << endl;
            break;
